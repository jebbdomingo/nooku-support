...
<ktml:module position="toolbar">
    <ktml:toolbar type="actionbar" title="COM_SUPPORT_SUBMENU_ACTIVITIES" icon="task icon-stack">
</ktml:module>
            ...
            <div class="support_table_container">
                <table class="table table-striped footable">
                    ...
                    <tr>
                        ...
                        <th class="support_table__message_field">
                            <?= translate('Message'); ?>
                        </th>
                    ...
                    <? foreach ($activities as $activity): ?>
                        <tr>
                            ...
                            <td class="support_table__message_field">
